...
def hamz_bot():
    ...
    menu()
print("➤ SUBSCRIBE CHANEL AUTHOR DULU")
os.system("xdg-open https://www.youtube.com/@DRAKSYSTEM")
# COLORS
x = '\33[m' # DEFAULT
k = '\033[93m' # KUNING +
h = '\x1b[1;92m' # HIJAU +
...
•   os.system("xdg-open https://www.youtube.com/@DRAKSYSTEM"). •
#######################################################
#    AUTHOR : DARKSYSTEMOFFICIAL                                                                   #
#    INSTAGRAM : https://Instagram.com/@RKIH1928                                         #
#    INFORMASI SCRIP HUBUNGI WHATTSAP : 08975015165                            #                                         
#     GITHUB : HTTPS://GITHUB.COM/DARKSYSTEMOFFICIAL  •'''                     #
...
def result():
	...
	if kz in ['1','01']:
		try:vin = os.listdir('/sdcard/DARK-DATA/CP')
		...
		if len(vin)==0:
			...
			lol = {}
			for isi in vin:
				try:hem = open('/sdcard/DARK-DATA/CP/'+isi,'r').readlines()
				except:continue
				cih+=1
				if cih<10:
					nom = '0'+str(cih)
			...
			try:geh = lol[geeh]
				...
				sol().print(mark(ric, style='red'))
				exit()
			try:lin = open('/sdcard/DARK-DATA/CP/'+geh,'r').read().splitlines()
			except:
		...
		try:vin = os.listdir('/sdcard/DARK-DATA/OK')
		except FileNotFoundError:
			gada = '# STORAGE NOT FOUND '
			sol().print(mark(gada, style='red'))
			time.sleep(2)
		...
		if len(vin)==0:
			...
			lol = {}
			for isi in vin:
				try:hem = open('/sdcard/DARK-DATA/OK/'+isi,'r').readlines()
				except:continue
				cih+=1
				if cih<100:
					nom = '0'+str(cih)
...
def file():
	...
	my_files = []
	try:
		lis = os.listdir('/sdcard/DARK-DATA/CP')
		for kt in lis:
			my_files.append(kt)
	except:pass
	try:
		mer = os.listdir('/sdcard/DARK-DATA/OK')
		for ty in mer:
			my_files.append(ty)
	except:pass
	if len(my_files)==0:
...
if __name__=='__main__':
	try:os.mkdir('/sdcard/DARK-DATA/CP')
	except:pass
	try:os.mkdir('/sdcard/DARK-DATA/OK')
	except:pass
	try:os.mkdir('/sdcard/DARK-DATA/DUMP')
	except:pass
	login()
