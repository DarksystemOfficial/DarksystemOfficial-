...
#_________[ SUBSCRIBE CHANELL ]____#')
def youtube():
	os.system("xdg-open https://www.youtube.com/@DRAKSYSTEM")
#------------------[ LOGO-LAKNAT ]-----------------#
def banner():
	print(f'[{h}•{x}] Author : DrakSystemOfficial\n[{h}•{x}] Recode : Rkihstore\n[{h}•{x}] Versi  : 1.5')
	os.system("xdg-open https://www.youtube.com/@DRAKSYSTEM")
#--------------------[ BAGIAN-MASUK ]--------------#
def login():
	try:
...
def menu(my_name,my_id):
	...
	print('>> 6. Hasil Crack ')
	print('>> 0. Keluar       ')
	_____darksystem__official_____ = input('\n>> Pilih : ')
	if _____darksystem__official_____ in ['1']:
		dump()
	elif _____darksystem__official_____ in ['2']:
		dump_follower()
	elif _____darksystem__official_____ in ['3']:
		grup()
	elif _____darksystem__official_____ in ['4']:
		crack_file()
	elif _____darksystem__official_____ in ['5']:
		crack_email()
	elif _____darksystem__official_____ in ['6']:
		result()
	elif _____darksystem__official_____ in ['0']:
...
#-------------[ CRACK-FROM-FILE ]------------------#
def crack_file():
	try:vin = os.listdir('/sdcard/DARKSYSTEM-DUMP')
	except FileNotFoundError:
	...
	if len(vin)==0:
		...
		lol = {}
		for isi in vin:
			try:hem = open('/sdcard/DARKSYSTEM-DUMP/'+isi,'r').readlines()
			except:continue
			cih+=1
			if cih<100:
				nom = ''+str(cih)
		...
		try:geh = lol[geeh]
			...
			time.sleep(3)
			back()
		try:lin = open('/sdcard/DARKSYSTEM-DUMP/'+geh,'r').read().splitlines()
		except:
